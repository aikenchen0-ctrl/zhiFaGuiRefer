...
| 顺序 | 文档 | 用途 |
|---|---|---|
| 1 | [AI 浏览器总体架构](architecture/ai-browser-overview.md) | 会话、前后台表面、执行权、观察、动作、验证和第一阶段边界 |
| 2 | [参考项目吸收计划](architecture/reference-absorption-plan.md) | 根工程候选、五类迁移策略、模块来源、删减项和实施顺序 |
| 3 | [技能契约](specs/skill-contract.md) | 参数、前置条件、成功判据、失效判据和回退 |
| 4 | [架构文档索引](architecture/README.md) | 当前架构与通用 GUI 执行背景的边界 |
| 5 | [决策文档索引](decision-records/README.md) | 当前决策、支撑决策和历史材料 |
